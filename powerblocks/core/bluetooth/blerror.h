...
#define BLERROR_CONNECTION_REFUSED_BAD_PSM      -8
#define BLERROR_CONNECTION_REFUSED_SECURITY     -9
#define BLERROR_CONNECTION_REFUSED_NO_RESOURCED -10
#define BLERROR_CONNECTION_REFUSED_UNKNOWN      -11

// BLTools Specific
#define BLERROR_DRIVER_INITIALIZE_FAIL          -12
#define BLERROR_NO_DRIVER_FOUND                 -13